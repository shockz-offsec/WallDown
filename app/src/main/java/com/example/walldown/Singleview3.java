    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.fav:
                ...
                if (Favoritos.getInstance().esFavorito(imageAdapter3.animals[position])) {
                    Favoritos.getInstance().deleteFav(imageAdapter3.animals[position]);
                    Toast.makeText(Singleview3.this, "Se ha quitado de Favoritos", Toast.LENGTH_SHORT).show();
                } else {
                    Favoritos.getInstance().addFav(imageAdapter3.animals[position]);
                    Toast.makeText(Singleview3.this, "Se ha añadido a Favoritos", Toast.LENGTH_SHORT).show();
                }
                toret = true;
                break;
        ...
        switch (menuItem.getItemId()) {
            case R.id.establecer:
                ...
                try {
                    ...
                    Toast.makeText(Singleview3.this, "Wallpaper Actualizado Correctamente", Toast.LENGTH_SHORT).show();
                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(Singleview3.this, "Fallo al actualizar el fondo de pantalla", Toast.LENGTH_SHORT).show();
                }
                toret = true;
                break;
            ...
            case R.id.descargar:
                if (isExternalStorageWritable()) {
                    Bitmap d = BitmapFactory.decodeResource(getResources(), imageAdapter3.animals[position]);
                    ...
                    try {
                        ...
                        out.flush();
                        out.close();
                        Toast.makeText(Singleview3.this, "Wallpaper Descargado Correctamente", Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        Toast.makeText(Singleview3.this, "Fallo al descargar", Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
                } else {
                    Toast.makeText(Singleview3.this, "Habilita los permisos de almacenamiento externo", Toast.LENGTH_SHORT).show();
                }
                toret = true;
                break;
        }
